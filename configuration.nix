...
let
  flake-compat = builtins.fetchTarball {url="https://github.com/edolstra/flake-compat/archive/master.tar.gz";sha="sha256-Ziq5/9d56G5bZOIv32JpUIeVU5l9SvF8ZJnCaU7xm00="; 
